...
while($row=mysqli_fetch_assoc($run)) {
 ...
 $description=$row['description'];
	...
	echo '<form class="form fv-plugins-bootstrap fv-plugins-framework" id="updateserviceform" novalidate="novalidate" action="product_details/update_product.php" method="post" enctype="multipart/form-data">
			<!--begin::Title-->
