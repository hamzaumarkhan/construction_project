...
<body id="kt_body"
								...
								<div class="d-flex align-items-baseline flex-wrap mr-5">
									...
									<ul
										...
										<li class="breadcrumb-item">
											<a class="text-muted">Products List</a>
										</li>
	...
	<script>
		...
		function load_service() {
			$("#box").load("product_details/load_product.php");
		}


		function adds_service() {

			if (fetch('product_details/add_product.php', {
					method: "POST",
		...
		function del_service(id) {
			...
			if (confirm("Confimm delete id = " + value)) {
				$.ajax({
					...
					url: 'product_details/del_product.php',
		...
		function edit_service(id) {
			...
			$.ajax({
				...
				url: 'product_details/edit_product.php',
				success: function (data) {
