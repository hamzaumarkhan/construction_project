...
<body id="kt_body"
						...
						<div
							...
							<div class="d-flex align-items-center flex-wrap mr-1">
								<div class="d-flex align-items-baseline flex-wrap mr-5">
									<h5 class="text-dark font-weight-bold my-1 mr-5">Commercial</h5>
									<ul
										class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">

										<li class="breadcrumb-item">
											<a class="text-muted">Commercial List</a>
										</li>
							...
							<div class="card-toolbar">
								...
								<a class="btn btn-primary font-weight-bolder" type="button" data-toggle="modal"
									...
									<i class="fas fa-plus-circle"></i> Add Commercial </a>
								<!--end::Button-->
							</div>
						</div>
					</div>
		...
		<div class="modal-dialog  modal-dialog-centered " role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLongTitle">Add New Commercial</h5>
	...
	<script>
		...
		function load_service() {
			$("#box").load("commercial/load_commercial.php");
		}


		function adds_service() {

			if (fetch('commercial/add_commercial.php', {
					method: "POST",
		...
		function del_service(id) {
			...
			if (confirm("Confimm delete id = " + value)) {
				$.ajax({
					...
					url: 'commercial/del_commercial.php',
		...
		function edit_service(id) {
			...
			$.ajax({
				...
				url: 'commercial/edit_commercial.php',
				success: function (data) {
