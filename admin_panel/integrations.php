...
<body id="kt_body"
						...
						<div
							...
							<div class="d-flex align-items-center flex-wrap mr-1">
								<div class="d-flex align-items-baseline flex-wrap mr-5">
									<h5 class="text-dark font-weight-bold my-1 mr-5">Integrations</h5>
									<ul
										class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">

										<li class="breadcrumb-item">
											<a class="text-muted">Integrations List</a>
										</li>
							...
							<div class="card-toolbar">
								...
								<a class="btn btn-primary font-weight-bolder" type="button" data-toggle="modal"
									...
									<i class="fas fa-plus-circle"></i> Add integrations </a>
								<!--end::Button-->
							</div>
						</div>
					</div>
		...
		<div class="modal-dialog  modal-dialog-centered " role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLongTitle">Add New Integrations</h5>
				...
				<form class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_login_singin_form"
					...
					<div class="modal-body" id="servicearea">
						...
						<div class="form-group ">
							...
							<input class="form-control h-auto py-4 rounded-lg " type="text" id="image" name="image"
								required>
							<div class="fv-plugins-message-container"></div>
						</div>
	...
	<script>
		...
		function load_service() {
			$("#box").load("integrations/load_integrations.php");
		}


		function adds_service() {

			if (fetch('integrations/add_integrations.php', {
					method: "POST",
		...
		function del_service(id) {
			...
			if (confirm("Confimm delete id = " + value)) {
				$.ajax({
					...
					url: 'integrations/del_integrations.php',
		...
		function edit_service(id) {
			...
			$.ajax({
				...
				url: 'integrations/edit_integrations.php',
				success: function (data) {
