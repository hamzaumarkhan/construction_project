...
<body id="kt_body"
						...
						<div
							...
							<div class="d-flex align-items-center flex-wrap mr-1">
								<div class="d-flex align-items-baseline flex-wrap mr-5">
									<h5 class="text-dark font-weight-bold my-1 mr-5">Menu Tab</h5>
									<ul
										class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">

										<li class="breadcrumb-item">
											<a class="text-muted">Menu Tab List</a>
										</li>
							...
							<div class="card-toolbar">
								...
								<a class="btn btn-primary font-weight-bolder" type="button" data-toggle="modal"
									...
									<i class="fas fa-plus fa-1x"></i> Add Category </a>
								<!--end::Button-->
							</div>
						</div>
					</div>
	...
	<script>
		...
		function load_service() {
			$("#box").load("category_details/load_category.php");
		}


		function adds_service() {

			if (fetch('category_details/add_category.php', {
					method: "POST",
		...
		function del_service(id) {
			...
			if (confirm("Confimm delete id = " + value)) {
				$.ajax({
					...
					url: 'category_details/del_category.php',
		...
		function edit_service(id) {
			...
			$.ajax({
				...
				url: 'category_details/edit_category.php',
				success: function (data) {
