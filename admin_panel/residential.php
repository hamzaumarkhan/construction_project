...
<body id="kt_body"
						...
						<div
							...
							<div class="d-flex align-items-center flex-wrap mr-1">
								<div class="d-flex align-items-baseline flex-wrap mr-5">
									<h5 class="text-dark font-weight-bold my-1 mr-5">Residential</h5>
									<ul
										class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">

										<li class="breadcrumb-item">
											<a class="text-muted">Residential List</a>
										</li>
							...
							<div class="card-toolbar">
								...
								<a class="btn btn-primary font-weight-bolder" type="button" data-toggle="modal"
									...
									<i class="fas fa-plus-circle"></i> Add Residential </a>
								<!--end::Button-->
							</div>
						</div>
					</div>
		...
		<div class="modal-dialog  modal-dialog-centered " role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLongTitle">Add New Residential</h5>
	...
	<script>
		...
		function load_service() {
			$("#box").load("residential/load_residential.php");
		}


		function adds_service() {

			if (fetch('residential/add_residential.php', {
					method: "POST",
		...
		function del_service(id) {
			...
			if (confirm("Confimm delete id = " + value)) {
				$.ajax({
					...
					url: 'residential/del_residential.php',
		...
		function edit_service(id) {
			...
			$.ajax({
				...
				url: 'residential/edit_residential.php',
				success: function (data) {
