...
while($row=mysqli_fetch_assoc($run)) {
	...
	$subtitle=$row['subtitle'];
	 ...
	 echo  '
	 		<form class="form fv-plugins-bootstrap fv-plugins-framework" id="updateserviceform" novalidate="novalidate" action="features/update_features.php" method="post" enctype="multipart/form-data">
					<!--begin::Title-->
