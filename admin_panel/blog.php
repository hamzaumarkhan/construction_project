...
<body id="kt_body"
						...
						<div
								...
								<div class="d-flex align-items-baseline flex-wrap mr-5">
									...
									<ul
										...
										<li class="breadcrumb-item">
											<a class="text-muted">Blogs List</a>
										</li>
							...
							<div class="card-toolbar">
								...
								<a class="btn btn-primary font-weight-bolder" type="button" data-toggle="modal"
									...
									<i class="fas fa-plus-circle"></i> Add Blog </a>
								<!--end::Button-->
							</div>
						</div>
					</div>
	...
	<script>
		...
		function load_service() {
			$("#box").load("blog/load_blog.php");
		}


		function adds_service() {

			if (fetch('blog/add_blog.php', {
					method: "POST",
