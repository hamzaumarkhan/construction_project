...
<body id="kt_body"
						...
						<div
							...
							<div class="d-flex align-items-center flex-wrap mr-1">
								<div class="d-flex align-items-baseline flex-wrap mr-5">
									<h5 class="text-dark font-weight-bold my-1 mr-5">Security</h5>
									<ul
										class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">

										<li class="breadcrumb-item">
											<a class="text-muted">Security List</a>
										</li>
							...
							<div class="card-toolbar">
								...
								<a class="btn btn-primary font-weight-bolder" type="button" data-toggle="modal"
									...
									<i class="fas fa-plus-circle"></i>Add Security </a>
								<!--end::Button-->
							</div>
						</div>
					</div>
		...
		<div class="modal-dialog  modal-dialog-centered " role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLongTitle">Add New Security</h5>
	...
	<script>
		...
		function load_service() {
			$("#box").load("security/load_security.php");
		}


		function adds_service() {

			if (fetch('security/add_security.php', {
					method: "POST",
		...
		function edit_service(id) {
			...
			$.ajax({
				...
				url: 'security/edit_security.php',
				success: function (data) {
