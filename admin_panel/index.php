				...
				<form class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_login_singin_form"
					...
					<div class="modal-body" id="servicearea">
						...
						<div class="form-group ">
							...
							<input class="form-control h-auto py-4 rounded-lg " type="text" id="subtitle"
								name="subtitle" required>
							<div class="fv-plugins-message-container"></div>
						</div>
						<div class="form-group ">
							<label class=" font-weight-bolder text-dark"> Select category</label>
							<select class="form-control h-auto py-4 rounded-lg " id="service_category"
                    ...
                    ?>
						...
						<div class="form-group ">
							...
							<textarea class="form-control h-auto py-4 rounded-lg " id="description" name="description"
								required></textarea>
							<div class="fv-plugins-message-container"></div>
						</div>
