...
<body id="kt_body"
						...
						<div
								...
								<div class="d-flex align-items-baseline flex-wrap mr-5">
									...
									<ul
										...
										<li class="breadcrumb-item">
											<a class="text-muted">Features Details List</a>
										</li>
							...
							<div class="card-toolbar">
								...
								<a class="btn btn-primary font-weight-bolder" type="button" data-toggle="modal"
									...
									<i class="fas fa-plus-circle"></i> Add Features Details </a>
								<!--end::Button-->
							</div>
						</div>
					</div>
		...
		<div class="modal-dialog  modal-dialog-centered " role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLongTitle">Add New features_details</h5>
	...
	<script>
		...
		function load_service() {
			$("#box").load("features_details/load_details.php");
		}


		function adds_service() {

			if (fetch('features_details/add_details.php', {
					method: "POST",
		...
		function del_service(id) {
			...
			if (confirm("Confimm delete id = " + value)) {
				$.ajax({
					...
					url: 'features_details/del_details.php',
		...
		function edit_service(id) {
			...
			$.ajax({
				...
				url: 'features_details/edit_details.php',
				success: function (data) {
